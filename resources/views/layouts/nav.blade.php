        ...
        <ul class="nav navbar-nav float-right">
          <li class="dropdown dropdown-language nav-item">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown-flag">
              <a class="dropdown-item" href="dashboard-analytics.html" data-language="en">
                <i class="flag-icon flag-icon-us mr-50"></i> English
              </a>
              <a class="dropdown-item" href="dashboard-analytics.html" data-language="fr">
                <i class="flag-icon flag-icon-fr mr-50"></i> French
              </a>
              <a class="dropdown-item" href="dashboard-analytics.html" data-language="de">
                <i class="flag-icon flag-icon-de mr-50"></i> German
              </a>
              <a class="dropdown-item" href="dashboard-analytics.html" data-language="pt">

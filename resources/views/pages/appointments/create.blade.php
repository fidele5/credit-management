            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" method="post" action="{{ route('appointment.store') }}">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" id="basicSelect" name="client_id">
                                                    @foreach ($clients as $client)
                                                        <option value="{{ $client->id }}" {{ isset($selectedClient) && $selectedClient->id === $client->id ? 'selected' : '' }}>{{ $client->person->first_name }} {{ $client->person->last_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
